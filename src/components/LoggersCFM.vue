<template>
    <div id="elogs_cfm">
        ...
        <h4>eLogs CFM</h4>
        <p>Укажите свой логин/пароль доступа к системе LoTW, eQSL или HAMLOG. После нажатия «OK» пройдет проверка связи с eLOG-сервером.<br/>Если всё прошло хорошо, появится значок <img src="/images/icon_connected.png" width="12">. CFMD QSO скачаются после 19:00 мск и после проверки будут добавлены к вашей статистике.<br/>Увидеть то, что пойдет зачёт, можно в разделе "Мои загрузки". В дальнейшем новые CFM QSO будут скачиваться <u>один раз в неделю</u>.<br/>Если вы хотите запустить скачивание вручную, нажмите кнопку "Обновить - Update".<br/>CFMD QSO скачаются после 19:00 мск и после проверки будут добавлены к вашей статистике во время пересчёта. </p>
        <p class="grey_note">
