      ...
      <div id="upload">
        <div id="upload_rules" @click="showInfo = !showInfo">Правила загрузки ADIF</div>
            <ul id="upload_info" v-if="showInfo">
              ...
              <li>Если <b>активатор</b> работал из RDA района <b>коллективным позывным</b> (<i>например, позывным R7AB работали операторы R7DA и R7TU</i>), то можно отметить "Также подтвердить..." и написать позывные операторов коллективной станции, чтобы проведенные QSO пошли в зачёт и операторам.</li>
