      ...
      <div id="upload">
        <div id="upload_rules" @click="showInfo = !showInfo">Правила загрузки ADIF</div>
            <ul id="upload_info" v-if="showInfo">
              ...
              <li><b>Правильная кодировка</b> ADI файла - <b>UTF8</b>. Это самая распространенная ошибка при загрузке.<br/>Если ошибка при загрузке всё же появляется, пришлите на <u><b>support@cfmrda.ru</b></u> свой ADI файл. Мы загрузим его сами.</li>
              <li>Чтобы не было повторных QSO, свой ADIF <b>желательно</b> закачивать в базу данных <b>один раз</b>. А потом уже догружать только новые QSO.</li>
