<template>
    <div>
        ...
        <table id="cfm_qso_request">
            <tr>
                <td colspan="10" class="no_border">
                    <input type="text" name="rda_callsign" id="rda_callsign" 
                        v-model="request.correspondent" :class="{error: validationErrors.correspondent}"/>
                </td>
            </tr>
            <tr>
                <td colspan="9" class="rda_callsign_note">Позывной корреспондента - Correspondent callsign</td>
            </tr>
            <tr>
                <td colspan="9" class="no_border">
                    <input type="text" name="rda_callsign" id="rda_callsign" 
            ...
            <tr>
                <td class="menu rda_callsign">Your callsign</td>
                ...
                <td class="menu my_callsign">Station callsign</td>
